...
with open("/tmp/pwd.txt", 'r') as temp:
    for line in temp:
        ...
        if "No-cmdb" in line:
            ...
            flag = False
            with open("/Users/emaksimov/PycharmProjects/query_sys0.csv") as cmdb:
            ...
            with open('/tmp/out.txt', 'a') as infile:
                infile.write(line)
            print(line.strip())
